  ...
  server <- function(input, output, session) {
    ...
    #setwd("/Users/clemensweisgram/Desktop/Bay Area Business Aviation Project/FINAL APP")
    ...
    data2020 <- read_excel("./data2020.xlsx", col_types = c("text", "text", "text", "text", "text", "text", "text", "text", "text", "text", "text", "text", "text", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric"))
    data2021 <- read_excel("./data2021.xlsx")
      ...
      analysis %>%
        ...
        addCircleMarkers(
          popup = ~ paste("<strong>", airport, "</strong>","<br>", 
                          "Change Jan 2020-Jan 2021: ", round(rel_dif*100, 1), "%", "<br>", 
                          "Total Movements Jan 2021: ", total_ops_2021, sep = ""), 
